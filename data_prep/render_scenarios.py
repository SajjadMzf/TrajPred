...
class RenderScenarios:
    ...
    def __init__(
        ...
        self.fr_div = 10/p.FPS#self.metas[rc.FRAME_RATE]/p.FPS
        if self.fr_div<=0:
        ...
        self.frames_data, image_width = rc.read_track_csv(track_path, pickle_path,reload = False, group_by = 'frames', fr_div = self.fr_div)
